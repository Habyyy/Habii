            ...
            <div class="bg-white shadow-md rounded my-6">
                <table class="min-w-full bg-white grid-cols-1">
                    ...
                    <tr>
                        ...
                        <th class="w-1/3 py-3 px-4 uppercase font-semibold text-sm">Stok Barang</th>
                    ...
                    <!-- Static Data Rows -->
                    <?php foreach ($obj_brg as $barang) { ?>
                                <tr class="text-center">
                                    <td class="py-3 px-4 text-blue-600"><?php echo htmlspecialchars($barang->id_brg) ?></td>
                                    <td class="w-1/4 py-3 px-4"><?php echo htmlspecialchars($barang->nama_brg) ?></td>
                                    <td class="w-1/3 py-3 px-4"><?php echo htmlspecialchars($barang->stok_brg) ?></td>
                                    <td class="w-1/6 py-3 px-4"><?php echo htmlspecialchars($barang->harga_brg) ?></td>
